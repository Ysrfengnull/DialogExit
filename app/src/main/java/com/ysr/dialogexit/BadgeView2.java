...
/**
 * Created by ysr on 2017/9/26 下午2:14.
...
public class BadgeView2 extends TextView {
     ...
     * Constructor -
     * <p>
     * create a new BadgeView2 instance attached to a target {@link android.view.View}.
     *
     ...
     * Constructor -
     * <p>
     * create a new BadgeView2 instance attached to a target {@link android.widget.TabWidget}
     ...
     * @param msgs
     */
    public void showNum(int msgs) {
        this.setNum(msgs);
        this.setTextColor(Color.WHITE);
        this.setBadgePosition(BadgeView2.POSITION_TOP_RIGHT);
        this.setAlpha(1f);
        this.show();
    }

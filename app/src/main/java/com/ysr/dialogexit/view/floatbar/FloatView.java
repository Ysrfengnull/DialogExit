...
//                            +" y = "+mFlFloatLogo.getY());
    ...
    private void refreshFloatMenu(boolean right) {
        ...
        if (right) {
            paramsMenuAccount.rightMargin = getResources().getDrawable(R.mipmap.qiandao_fengyunbang_icon).getIntrinsicWidth()-6;//+6
            ...
            paramsMenuAccount.leftMargin = getResources().getDrawable(R.mipmap.qiandao_fengyunbang_icon).getIntrinsicWidth()+6;

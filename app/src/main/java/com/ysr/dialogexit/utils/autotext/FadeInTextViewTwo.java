package com.ysr.dialogexit.utils.autotext;
...
public class FadeInTextViewTwo extends TextView {
    ...
    public FadeInTextViewTwo setTextAnimationListener(TextAnimationListener textAnimationListener) {
        this.textAnimationListener = textAnimationListener;
        return this;
    }

    public FadeInTextViewTwo(Context context) {
        this(context, null);
    }

    public FadeInTextViewTwo(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
...
//        }
     ...
     * @return
     */
    public FadeInTextViewTwo setTextString(String textString) {
        if (textString != null) {
            //总字数
     ...
     * @return
     */
    public FadeInTextViewTwo startFadeInAnimation() {
     ...
     * @return
     */
    public FadeInTextViewTwo stopFadeInAnimation() {
        if (textAnimation != null) {
            textAnimation.end();
        }
        return this;

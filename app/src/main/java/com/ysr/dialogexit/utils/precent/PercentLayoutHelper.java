...
package com.ysr.dialogexit.utils.precent;
...
public class PercentLayoutHelper
{
    ...
    public void adjustChildren(int widthMeasureSpec, int heightMeasureSpec)
    {
        ...
        {
            Log.e(TAG, "adjustChildren: " + mHost + " widthMeasureSpec: "
        ...
        if (Log.isLoggable(TAG, Log.DEBUG))
            Log.e(TAG, "widthHint = " + widthHint + " , heightHint = " + heightHint);
        ...
        for (int i = 0, N = mHost.getChildCount(); i < N; i++)
        {
            ...
            if (Log.isLoggable(TAG, Log.DEBUG))
            {
                Log.e(TAG, "should adjust " + view + " " + params);
            }
    ...
    {
        if (Log.isLoggable(TAG, Log.DEBUG))
            Log.e(TAG, methodName + " ==> " + percentVal);
        if (percentVal != null)
        {
    ...
    public void restoreOriginalParams()
    {
        for (int i = 0, N = mHost.getChildCount(); i < N; i++)
        {
            ...
            if (Log.isLoggable(TAG, Log.DEBUG))
            {
                Log.e(TAG, "should restore " + view + " " + params);
            }
            if (params instanceof PercentLayoutParams)
            {
                PercentLayoutInfo info =
    ...
    public boolean handleMeasuredStateTooSmall()
    {
        ...
        for (int i = 0, N = mHost.getChildCount(); i < N; i++)
        {
            ...
            if (Log.isLoggable(TAG, Log.DEBUG))
            {
                Log.e(TAG, "should handle measured state too small " + view + " " + params);
            }
            if (params instanceof PercentLayoutParams)
            {
                PercentLayoutInfo info =
        ...
        if (Log.isLoggable(TAG, Log.DEBUG))
        {
            Log.e(TAG, "should trigger second measure pass: " + needsSecondMeasure);
        }
    ...
    public static class PercentLayoutInfo
    {
                                     ...
                                     int heightHint)
        {
            ...
            if (Log.isLoggable(TAG, Log.DEBUG))
            {
                Log.e(TAG, "after fillLayoutParams: (" + params.width + ", " + params.height + ")");
            }
        }
                                           ...
                                           int heightHint)
        {
            ...
            if (Log.isLoggable(TAG, Log.DEBUG))
            {
                Log.e(TAG, "after fillMarginLayoutParams: (" + params.width + ", " + params.height
                        + ")");
            }
        }
